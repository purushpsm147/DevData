...
namespace SGRE.TSA.DataStore.API.Migrations
{
    ...
    [Migration("20210214103730_scenarioBaseTowerSstConnect")]
    partial class scenarioBaseTowerSstConnect
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.BaseTower", b =>
                {
                    ...
                    b.Property<string>("FeaturesDocLink")
                        .HasColumnType("text")
                        .HasColumnName("features_doc_link");
                    ...
                    b.Property<bool>("IsRnaLoadsMarginAvailable")
                        .HasColumnType("boolean")
                        .HasColumnName("is_rna_loads_margin_available");

                    b.Property<bool>("IsSarInputRequest")
                        .HasColumnType("boolean")
                        .HasColumnName("is_sar_input_request");

                    b.Property<bool>("IsTowerLoadsMarginAvailable")
                        .HasColumnType("boolean")
                        .HasColumnName("is_tower_loads_margin_available");
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.BaseTowerDesignDimension", b =>
                {
                    ...
                    b.Property<bool>("IsStandardFoundationHeight")
                        .HasColumnType("boolean")
                        .HasColumnName("is_standard_foundation_height");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_base_tower_design_dimensions");

                    b.HasIndex("BaseTowerId")
                        .HasDatabaseName("ix_base_tower_design_dimensions_base_tower_id");

                    b.ToTable("base_tower_design_dimensions");
                });
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.BaseTowerDesignDimension", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.BaseTower", "BaseTower")
                        .WithMany("BaseTowerDesignDimensions")
                        .HasForeignKey("BaseTowerId")
                        .HasConstraintName("fk_base_tower_design_dimensions_base_tower_base_tower_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.BaseTower", b =>
                {
                    b.Navigation("BaseTowerDesignDimensions");
                });
