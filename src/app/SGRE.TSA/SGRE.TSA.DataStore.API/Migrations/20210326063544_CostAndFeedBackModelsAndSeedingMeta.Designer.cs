...
namespace SGRE.TSA.DataStore.API.Migrations
{
    ...
    [Migration("20210326063544_CostAndFeedBackModelsAndSeedingMeta")]
    partial class CostAndFeedBackModelsAndSeedingMeta
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostOverView", b =>
                {
                    ...
                    b.Property<int>("CostOverViewMetaId")
                        .HasColumnType("integer")
                        .HasColumnName("cost_over_view_meta_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_cost_over_view");

                    b.HasIndex("CostOverViewMetaId")
                        .HasDatabaseName("ix_cost_over_view_cost_over_view_meta_id");

                    b.HasIndex("QuoteId")
                        .HasDatabaseName("ix_cost_over_view_quote_id");

                    b.HasIndex("ScenarioId")
                        .HasDatabaseName("ix_cost_over_view_scenario_id");

                    b.ToTable("cost_over_view");
                });
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTechnicalOffice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("AdditinalFeedback")
                        .HasColumnType("text")
                        .HasColumnName("additinal_feedback");

                    b.Property<double>("AdditionalTimelineWeeksWindfarm")
                        .HasColumnType("double precision")
                        .HasColumnName("additional_timeline_weeks_windfarm");

                    b.Property<int>("CostOverViewId")
                        .HasColumnType("integer")
                        .HasColumnName("cost_over_view_id");

                    b.Property<double>("DesignCostsWindfarm")
                        .HasColumnType("double precision")
                        .HasColumnName("design_costs_windfarm");

                    b.Property<string>("EvaluationDocLink")
                        .HasColumnType("text")
                        .HasColumnName("evaluation_doc_link");

                    b.Property<DateTimeOffset?>("LastModifiedDateTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_modified_date_time");

                    b.Property<double>("ManufacturingInvestmentCostsWindfarm")
                        .HasColumnType("double precision")
                        .HasColumnName("manufacturing_investment_costs_windfarm");

                    b.Property<DateTimeOffset?>("RecordInsertDateTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("record_insert_date_time");

                    b.Property<string>("ToolkitEvaluation")
                        .HasColumnType("text")
                        .HasColumnName("toolkit_evaluation");

                    b.HasKey("Id")
                        .HasName("pk_costs_technical_office");

                    b.HasIndex("CostOverViewId")
                        .HasDatabaseName("ix_costs_technical_office_cost_over_view_id");

                    b.ToTable("costs_technical_office");
                });
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTechnology", b =>
                {
                    ...
                    b.Property<int>("TowerComponentCertificateWindfarmNomination")
                        .HasColumnType("integer")
                        .HasColumnName("tower_component_certificate_windfarm_nomination");

                    b.Property<int>("TowerComponentCertificateWindfarmOffer")
                        .HasColumnType("integer")
                        .HasColumnName("tower_component_certificate_windfarm_offer");

                    b.Property<int>("TowerComponentCertificateWindfarmSignature")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CostOverViewId")
                        .HasDatabaseName("ix_costs_technology_cost_over_view_id");

                    b.ToTable("costs_technology");
                });

            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTechnologyTowerDevelopmentLeadtime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<bool>("IsLeadtimeInputRequest")
                        .HasColumnType("boolean")
                        .HasColumnName("is_leadtime_input_request");

                    b.Property<DateTimeOffset?>("LastModifiedDateTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_modified_date_time");

                    b.Property<int>("LeadtimeTowerNomination")
                        .HasColumnType("integer")
                        .HasColumnName("leadtime_tower_nomination");

                    b.Property<int>("LeadtimeTowerOffer")
                        .HasColumnType("integer")
                        .HasColumnName("leadtime_tower_offer");

                    b.Property<int>("LeadtimeTowerSignature")
                        .HasColumnType("integer")
                        .HasColumnName("leadtime_tower_signature");

                    b.Property<DateTimeOffset?>("RecordInsertDateTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("record_insert_date_time");

                    b.Property<string>("envelop")
                        .HasColumnType("text")
                        .HasColumnName("envelop");

                    b.HasKey("Id")
                        .HasName("pk_costs_technology_tower_development_leadtime");

                    b.HasIndex("CostOverViewId")
                        .HasDatabaseName("ix_costs_technology_tower_development_leadtime_cost_over_view_");

                    b.ToTable("costs_technology_tower_development_leadtime");
                });
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerConstruction", b =>
                {
                    ...
                    b.HasIndex("CostOverViewId")
                        .HasDatabaseName("ix_costs_tower_construction_cost_over_view_id");
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerConstructionLeadTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("CostsTowerConstructionLeadTimeMetaId")
                        .HasColumnType("integer")
                        .HasColumnName("costs_tower_construction_lead_time_meta_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_costs_tower_construction_lead_time");

                    b.HasIndex("CostOverViewId")
                        .HasDatabaseName("ix_costs_tower_construction_lead_time_cost_over_view_id");

                    b.HasIndex("CostsTowerConstructionLeadTimeMetaId")
                        .HasDatabaseName("ix_costs_tower_construction_lead_time_costs_tower_construction");

                    b.ToTable("costs_tower_construction_lead_time");
                });
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerCustoms", b =>
                {
                    ...
                    b.HasIndex("CostOverViewId")
                        .HasDatabaseName("ix_costs_tower_customs_cost_over_view_id");

                    b.HasIndex("CostsTowerCustomsMetaId")
                        .HasDatabaseName("ix_costs_tower_customs_costs_tower_customs_meta_id");
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerExWorks", b =>
                {
                    ...
                    b.HasIndex("CostOverViewId")
                        .HasDatabaseName("ix_costs_tower_ex_works_cost_over_view_id");

                    b.HasIndex("CostsTowerExWorksMetaId")
                        .HasDatabaseName("ix_costs_tower_ex_works_costs_tower_ex_works_meta_id");
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerLogistics", b =>
                {
                    ...
                    b.HasIndex("CostOverViewId")
                        .HasDatabaseName("ix_costs_tower_logistics_cost_over_view_id");

                    b.HasIndex("CostsTowerLogisticsMetaId")
                        .HasDatabaseName("ix_costs_tower_logistics_costs_tower_logistics_meta_id");

                    b.ToTable("costs_tower_logistics");
                });

            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerLogisticsLeadTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CostOverViewId")
                        .HasDatabaseName("ix_costs_tower_logistics_lead_time_cost_over_view_id");
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerSupplier", b =>
                {
                    ...
                    b.HasIndex("CostOverViewId")
                        .HasDatabaseName("ix_costs_tower_supplier_cost_over_view_id");

                    b.HasIndex("CostsTowerSupplierMetaId")
                        .HasDatabaseName("ix_costs_tower_supplier_costs_tower_supplier_meta_id");
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostOverView", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverViewMeta", "CostOverViewMeta")
                        .WithMany()
                        .HasForeignKey("CostOverViewMetaId")
                        .HasConstraintName("fk_cost_over_view_cost_over_view_meta_cost_over_view_meta_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("SGRE.TSA.DataStore.API.Models.Quote", "Quote")
                        .WithMany()
                        .HasForeignKey("QuoteId")
                        .HasConstraintName("fk_cost_over_view_quotes_quote_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("SGRE.TSA.DataStore.API.Models.Scenario", "Scenario")
                        ...
                        .HasConstraintName("fk_cost_over_view_scenarios_scenario_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CostOverViewMeta");
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTechnicalOffice", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany()
                        .HasForeignKey("CostOverViewId")
                        .HasConstraintName("fk_costs_technical_office_cost_over_view_cost_over_view_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CostOverView");
                });
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTechnology", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany()
                        .HasForeignKey("CostOverViewId")
                        .HasConstraintName("fk_costs_technology_cost_over_view_cost_over_view_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTechnologyTowerDevelopmentLeadtime", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany()
                        .HasForeignKey("CostOverViewId")
                        .HasConstraintName("fk_costs_technology_tower_development_leadtime_cost_over_view_")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerConstruction", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany()
                        .HasForeignKey("CostOverViewId")
                        .HasConstraintName("fk_costs_tower_construction_cost_over_view_cost_over_view_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerConstructionLeadTime", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany()
                        .HasForeignKey("CostOverViewId")
                        .HasConstraintName("fk_costs_tower_construction_lead_time_cost_over_view_cost_over")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostsTowerConstructionLeadTimeMeta", "CostsTowerConstructionLeadTimeMeta")
                        .WithMany()
                        .HasForeignKey("CostsTowerConstructionLeadTimeMetaId")
                        .HasConstraintName("fk_costs_tower_construction_lead_time_costs_tower_construction")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CostOverView");

                    b.Navigation("CostsTowerConstructionLeadTimeMeta");
                });
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerCustoms", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany()
                        .HasForeignKey("CostOverViewId")
                        .HasConstraintName("fk_costs_tower_customs_cost_over_view_cost_over_view_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostsTowerCustomsMeta", "CostsTowerCustomsMeta")
                        ...
                        .HasConstraintName("fk_costs_tower_customs_costs_tower_customs_meta_costs_tower_cu")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerExWorks", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany()
                        .HasForeignKey("CostOverViewId")
                        .HasConstraintName("fk_costs_tower_ex_works_cost_over_view_cost_over_view_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostsTowerExWorksMeta", "CostsTowerExWorksMeta")
                        ...
                        .HasConstraintName("fk_costs_tower_ex_works_costs_tower_ex_works_meta_costs_tower_")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerLogistics", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany()
                        .HasForeignKey("CostOverViewId")
                        .HasConstraintName("fk_costs_tower_logistics_cost_over_view_cost_over_view_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostsTowerLogisticsMeta", "CostsTowerLogisticsMeta")
                        ...
                        .HasConstraintName("fk_costs_tower_logistics_costs_tower_logistics_meta_costs_towe")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerLogisticsLeadTime", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany()
                        .HasForeignKey("CostOverViewId")
                        .HasConstraintName("fk_costs_tower_logistics_lead_time_cost_over_view_cost_over_vi")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerSupplier", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany()
                        .HasForeignKey("CostOverViewId")
                        .HasConstraintName("fk_costs_tower_supplier_cost_over_view_cost_over_view_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostsTowerSupplierMeta", "CostsTowerSupplierMeta")
                        ...
                        .HasConstraintName("fk_costs_tower_supplier_costs_tower_supplier_meta_costs_tower_")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
