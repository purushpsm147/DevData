...
namespace SGRE.TSA.DataStore.API.Migrations
{
    ...
    [Migration("20210330111706_CostAndFeedBackModelsV2")]
    partial class CostAndFeedBackModelsV2
    {
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerLogisticsLineItem", b =>
                {
                    ...
                    b.HasIndex("CostsTowerLogisticsId")
                        .HasDatabaseName("ix_costs_tower_logistics_line_item_costs_tower_logistics_id");
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerLogisticsLineItem", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostsTowerLogistics", "CostsTowerLogistics")
                        ...
                        .HasConstraintName("fk_costs_tower_logistics_line_item_costs_tower_logistics_costs")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostsTowerLogisticsSupplier", null)
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerSupplierLineItem", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostsTowerSupplier", "CostsTowerSupplier")
                        ...
                        .HasConstraintName("fk_costs_tower_supplier_line_item_costs_tower_supplier_costs_to")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
