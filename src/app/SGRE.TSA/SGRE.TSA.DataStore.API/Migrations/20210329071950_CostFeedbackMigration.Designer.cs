...
namespace SGRE.TSA.DataStore.API.Migrations
{
    ...
    [Migration("20210329071950_CostFeedbackMigration")]
    partial class CostFeedbackMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTechnicalOffice", b =>
                {
                    ...
                    b.Property<decimal>("DesignCostsWindfarm")
                        .HasColumnType("numeric")
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTechnicalOffice", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany("CostsTechnicalOffices")
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTechnologyTowerDevelopmentLeadtime", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany("CostsTechnologyTowerDevelopmentLeadtimes")
                        .HasForeignKey("CostOverViewId")
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerConstruction", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany("CostsTowerConstructions")
                        .HasForeignKey("CostOverViewId")
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerConstructionLeadTime", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany("CostsTowerConstructionLeadTimes")
                        .HasForeignKey("CostOverViewId")
                        .HasConstraintName("fk_costs_tower_construction_lead_time_cost_over_view_cost_over_v")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostsTowerLogisticsLeadTime", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.CostOverView", "CostOverView")
                        .WithMany("CostsTowerLogisticsLeadTimes")
                        .HasForeignKey("CostOverViewId")
                        .HasConstraintName("fk_costs_tower_logistics_lead_time_cost_over_view_cost_over_view")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.CostOverView", b =>
                {
                    b.Navigation("CostsTechnicalOffices");

                    b.Navigation("CostsTechnologies");

                    b.Navigation("CostsTechnologyTowerDevelopmentLeadtimes");

                    b.Navigation("CostsTowerConstructionLeadTimes");
                    ...
                    b.Navigation("CostsTowerLogisticsLeadTimes");
