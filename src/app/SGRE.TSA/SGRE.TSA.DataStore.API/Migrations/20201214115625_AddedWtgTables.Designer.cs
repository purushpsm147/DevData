...
namespace SGRE.TSA.DataStore.API.Migrations
{
    ...
    [Migration("20201214115625_AddedWtgTables")]
    partial class AddedWtgTables
    {
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.WtgConfiguation", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_wtg_configuations");

                    b.HasIndex("QuoteId")
                        .HasDatabaseName("ix_wtg_configuations_quote_id");

                    b.HasIndex("WtgCatalogueId")
                        .HasDatabaseName("ix_wtg_configuations_wtg_catalogue_id");

                    b.ToTable("wtg_configuations");
                });
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.WtgConfiguation", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.Quote", "Quote")
                        ...
                        .HasConstraintName("fk_wtg_configuations_quotes_quote_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("SGRE.TSA.DataStore.API.Models.WtgCatalogue", "WtgCatalogue")
                        ...
                        .HasConstraintName("fk_wtg_configuations_wtg_catalogues_wtg_catalogue_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
