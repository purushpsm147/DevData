...
namespace SGRE.TSA.DataStore.API.Migrations
{
    ...
    [Migration("20201214095352_addedWtgCatalogandConfiguration")]
    partial class addedWtgCatalogandConfiguration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.WtgCatalogue", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_wtg_catalogue");

                    b.ToTable("wtg_catalogue");
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.WtgConfiguation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_wtg_configuation");

                    b.HasIndex("QuoteId")
                        .HasDatabaseName("ix_wtg_configuation_quote_id");

                    b.HasIndex("WtgCatalogueId")
                        .HasDatabaseName("ix_wtg_configuation_wtg_catalogue_id");

                    b.ToTable("wtg_configuation");
                });
            ...
            modelBuilder.Entity("SGRE.TSA.DataStore.API.Models.WtgConfiguation", b =>
                {
                    b.HasOne("SGRE.TSA.DataStore.API.Models.Quote", "Quote")
                        ...
                        .HasConstraintName("fk_wtg_configuation_quotes_quote_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("SGRE.TSA.DataStore.API.Models.WtgCatalogue", "WtgCatalogue")
                        ...
                        .HasConstraintName("fk_wtg_configuation_wtg_catalogue_wtg_catalogue_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
